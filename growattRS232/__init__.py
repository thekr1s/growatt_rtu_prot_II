...
class GrowattRS232:
    ...
    def sync_update(self):
        ...
        rir1 = self._client.read_input_registers(0, 125, unit=self._unit)
        if rir1.isError():
            self._client.close()
        ...
        print(f"rir1 {rir1.registers}")
        data = self.input_regs_to_data(rir1)
        # Inverter properties
    ...
    def input_regs_to_data(self, rir1):
        ...
        data[ATTR_INPUT_1_ENERGY_TODAY] = rsdf(rir1, 59)
        data[ATTR_INPUT_1_ENERGY_TOTAL] = rsdf(rir1, 61)
        ...
        data[ATTR_INPUT_2_ENERGY_TODAY] = rsdf(rir1, 63)
        data[ATTR_INPUT_2_ENERGY_TOTAL] = rsdf(rir1, 65)
        ...
        # data[ATTR_DERATING_MODE] = rssf(rir1, 104)
        # data[ATTR_DERATING] = DERATINGMODES[rssf(rir1, 104)]
        ...
        # data[ATTR_WARNING_CODE] = rsdf(rir1, 110, 1)
        # data[ATTR_WARNING] = WARNINGCODES[rir2.registers[19]]
        # data[ATTR_WARNING_VALUE] =  rssf(rir1, 112, 1)
